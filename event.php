...
<div class="main-content ">
		<div class="bg-event">
			...
			<div class="heading-title">
				<img id="event" src="<?php echo get_template_directory_uri();?>/image/su kien noi bat.png">
			</div>
				<div class="main-interaction-event">
					...
					<!-- Query get posts by categories -->
						<div id="chi-tiet" class="featured-post-container">
								<?php $args=array(
									'order'=>'DESC',
									'post_status'=>'publish',
									'showposts'=>'8',
