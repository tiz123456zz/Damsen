...
.the-nho{
    flex:1;
    background-image:url("<?php echo get_template_directory_uri();?>/image/the-nho.png");
    background-size:100%;
    width:100%;
    height:100%;
...
<div class="main-content">
            <div class="content-container">
                ...
                <div class="heading-title">
                    <img id="contact" src="<?php echo get_template_directory_uri();?>/image/Lien he.png">
                </div>
                <div class="main-interaction">
                        ...
                        <div class="form-content">
                            ...
                            <form action="#" id="form-contact" method="POST" name="form1" target="hidden_iframe" >
                                <table class="table-contact">
                                    ...
                                    <tr>
                                        <td colspan=2>
                                            <textarea name="message" id="message" placeholder="Lời nhắn" cols="30" hangs="10"></textarea>
                                        </td>
                                    </tr>
                    ...
                    <div  id="main-right-contact">
                        ...
                        <div class="phone-number the-nho">
